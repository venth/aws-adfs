...
* [duo security](https://duo.com) MFA provider with support for:
  ...
  * Both the classic and the newer single-page ("pwl") Duo Universal Prompt are supported; `WebAuthn Security Key` is not yet supported with the single-page prompt.
